...
def generate_samples(output_dir="../test-audio/generated"):
    ...
    print(f"  python vertano.py {output_dir}/english.mp3")
    print(f"  python vertano.py {output_dir}/spanish.mp3 --summary medium")
    print(f"  python vertano.py {output_dir}/meeting_notes.mp3 --format md")
