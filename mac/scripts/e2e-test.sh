...
MODEL="$HOME/Library/Application Support/Vertano/models/ggml-small.bin"
...
WORK="$(mktemp -d /tmp/vertano-e2e.XXXXXX)"
trap 'rm -rf "$WORK"' EXIT

echo "1/3 Synthesizing test speech..."
say -o "$WORK/speech.aiff" "The quick brown fox jumps over the lazy dog. This is a Vertano engine test."
